 ...
 * - Using any sub-key, for example 'path_to_field.path_to_key'. In this case, the search is delegated
 * to {@link DynamicKeyFieldMapper#keyedFieldType(String)}, with 'path_to_key' passed as the
